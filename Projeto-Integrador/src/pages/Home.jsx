...
import Img03 from '../imagens/entregador.jpg';
...
export default function Home(props){
    return (
        ...
        <div className='Perfis'>
              ...
              <Perfil imagem={Img02} titulo="Quero receber materiais" texto="Cadastre sua empresa ou cooperativa e receba os materiais coletados próximos!" picture={false}></Perfil>       
              <Perfil imagem={Img03} titulo="Quero fazer uma entrega" texto=" Colete e entregue os materiais e contribua com a sustentabilidade!"></Perfil>     
        </div>
